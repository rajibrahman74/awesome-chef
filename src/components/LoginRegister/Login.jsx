  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
      ...
      >
        ...
        >
          <img className="w-7 h-7 rounded-md" src={google} alt="" />
          <span>Continue with Google</span>
        </div>

        <div
          onClick={handleWithGithubSingIn}
          className="flex items-center justify-center gap-[6px] w-ful; mx-6 h-[50px] border border-slate-200 rounded-md cursor-pointer mt-3 mb-7"
        >
